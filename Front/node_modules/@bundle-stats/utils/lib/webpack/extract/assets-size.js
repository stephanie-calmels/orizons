...
const generateInitialSizeByType = () => _fileTypes.FILE_TYPES.reduce((accumulator, fileType) => _objectSpread(_objectSpread({}, accumulator), {}, {
...
const extractAssetsSize = (webpackStats, currentExtractedData) => {
  ...
  return {
    metrics: _objectSpread(_objectSpread({}, generic), {}, {
      sizes
    })
  };
};
