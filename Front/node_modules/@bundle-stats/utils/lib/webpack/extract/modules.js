...
const extractModules = (webpackStats = {}) => {
  ...
  const modulesByChunk = modules.reduce((aggregator, moduleEntry) => {
    ...
    return moduleChunks.reduce((aggWithChunks, chunkId) => _objectSpread(_objectSpread({}, aggWithChunks), {}, {
      [chunkId]: {
        chunkNames: getChunkNames(chunks, chunkId),
        modules: _objectSpread(_objectSpread({}, (0, _get2.default)(aggWithChunks, [chunkId, 'modules'])), {}, {
          [normalizedName]: {
            name,
            value: size
          }
